        ...
        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
          ...
          ?>
            ...
            if (isset($_POST['reserver'])) {
              $TTC = $prix * $numberOfDays;
              ajouter_reservation($idvehicule, $dateDepart, $agence, $dateRetour, $numberOfDays, $TTC);
            }
            ?>
                  ...
                  <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                      <div class="btn-group" role="group" aria-label="Default button group">
                        <button type="submit" name="reserver" class="btn btn-sm btn-outline-secondary">Réserver ce véhicule</button>
                        <button type="button" class="btn btn-sm btn-outline-secondary" onclick="MontantTotal(<?php echo $idvehicule; ?>,<?php echo $prix; ?>)">Voir
