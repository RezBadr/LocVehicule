        ...
        <div class="container">
            <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                ...
                <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                    <li><a href="profil.php" class="nav-link px-2 link-secondary">Reservations</a></li>
                ...
                <table class="table table-striped table-sm">
                    <thead>
                        <tr>
                            ...
                            <th scope="col">Agence de depart </th>
                    ...
                    <tbody>
                        <?php $result = afficher_reservation();
                        while (null !== ($row = mysqli_fetch_assoc($result))) { ?>
                        <tr>
                            <td><?php echo $row['IDreservation']; ?></td>
                            <td><?php echo $row['DateDepart']; ?></td>
                            <td><?php echo $row['AgenceDepart']; ?></td>
                            <td><?php echo $row['DateRetour']; ?></td>
                            <td><?php echo $row['AgenceRetour']; ?></td>
                            <td><?php echo $row['nombreJours']; ?></td>
